  ...
  createProductsList(products) {
    ...
    products.forEach(item => {
      ...
      <td class="cursor-pointer edit-product">
        <svg data-id="${item.id}" class="fill-primary w-4 lg:w-6" width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
      ...
      <td class="cursor-pointer delete-product">
        <svg data-id="${item.id}" class="fill-red-400 w-4 lg:w-6" width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
