...
class ProductView {
  ...
  createProductsList(products) {
    ...
    products.forEach(item => {
      ...
      <td data-id="${item.id}" class="cursor-pointer edit-product w-4 lg:w-6">
        <svg class="pointer-events-none fill-primary w-4 lg:w-6" width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
      ...
      <td data-id="${item.id}" class="cursor-pointer delete-product w-4 lg:w-6">
        <svg class="pointer-events-none fill-red-500 w-4 lg:w-6" width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
